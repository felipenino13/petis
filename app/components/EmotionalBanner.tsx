  ...
  return (
    <section className="bg-[#183e5b] px-5 py-24 text-white sm:px-8 lg:px-10">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div className="relative min-h-[360px] overflow-hidden rounded-lg shadow-[0_28px_80px_rgba(24,62,91,0.24)] lg:min-h-[520px]">
          <Image
            src="/petis-story.webp"
            alt="Ilustración de un perro y un gato rodeados de recuerdos felices"
            fill
